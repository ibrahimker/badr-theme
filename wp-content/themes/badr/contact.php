...
<header id="contact-header">
	<div class="container">
		...
		<div class="row">
			<p class="contact-subheader">Brief us about your project,</br> we will examine it and send you a quotation</p>
		</div>
		<div class="row">
			<a href="<?php echo get_site_url() ?>/contact/quotation" class="contact-header-button">
				<button type="button" class="btn btn-badr navbar-btn">REQUEST A QUOTATION</button>
			</a>
